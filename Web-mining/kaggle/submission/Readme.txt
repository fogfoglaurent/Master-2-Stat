...
#6) Pour chaque destinataire, on calcule le centroid des topics des mails recus a partir des distributions
#obtenus a partir du modele LDA
#7) Pour chaque mail, on calcule la distance au cosinus entre les topics du mail et le centroid du destinataire
#On calcule cette distance pour toutes les paires possibles
...
#centroid de l'echantillon d'apprentissage
